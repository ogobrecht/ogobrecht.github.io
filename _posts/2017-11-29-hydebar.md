...
Yesterday I released version 1.0.0. You can start blogging for free in five minutes with this [quick start guide][6]. The online demo is serving as template, documentation and showcase. The mentioned slides from the [DOAG Conference + Exhibition 2017][5] are included in this demo (in German, sorry...).
